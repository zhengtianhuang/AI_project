...
# ])  # 4 classes
model = load_model(
    filePath/'model/0504_10epeh500pochs.h5')  # 加載已經訓練好的模型
...
=======
                    steps_per_epoch=10, epochs=300)
model.save(filePath/'model/0504_10epeh800pochs.h5')
with open(filePath/'model/0504_10epeh800pochs.json', "w") as json_file:
>>>>>>> Stashed changes
